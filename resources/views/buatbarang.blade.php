...
<div class="bgimg">
		<div class="row justify-content-center align-items-center">
			<div class="col-md-4 col-sm-12 bg-dark p-4">
			...
			@endif
				<form method="post" action="/barang/create/process" enctype="multipart/form-data">
				@csrf
					<div class="form-group">
						<label class="font-weight-bold">Kode Barang</label>
						<input type="text" class="form-control" name="kode" placeholder="Enter Code" value="{{old('kode')}}" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<select class="form-control" name="kategori" required>
							<option value="">-- Pilih Kategori --</option>
								<option value="Cage" <?= (old('kategori')=='Cage')?'selected':'' ?>>Cage</option>
								<option value="Food" <?= (old('kategori')=='Food')?'selected':'' ?>>Food</option>
								<option value="Grooming" <?= (old('kategori')=='Grooming')?'selected':'' ?>>Grooming</option>
							</optgroup>
					   </select>
					</div>
					<div class="form-group">
						<label class="font-weight-bold">Harga</label>
						<input type="number" class="form-control" name="harga" placeholder="Enter Price" value="{{old('harga')}}" required>
					</div>
					<div class="form-group">
