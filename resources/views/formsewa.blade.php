...
<body>
    <div class="hero">
        <div class="form-box">                             
             ...
             <form id="login" action="/home2" class="input-g">
                <input type="text" class="input-field" placeholder="Nama Penyewa" required>
                ...
                <button type="submit" class="submit-btn" onclick="alert('Pembelian berhasil!')">Sewa</button>
             </form>
