		...
		<nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
		  ...
		  <div class="collapse navbar-collapse" id="navbarContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a onclick="alert('Anda Harus Login Terlebih dahulu')" class="nav-link" href="/login">Contact Us</a>
				</li>
				 <li class="nav-item">
					<a class="nav-link text" href="https://discord.gg/R55VNJBq">Join Our Comminity</a>
				</li>
				<li class="nav-item">
                <a onclick="alert('Anda Harus Login Terlebih dahulu')" class="nav-link" href="/login">Shop</a>
                </li>
			</ul>
